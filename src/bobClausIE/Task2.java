...
import bobClausIE.bobClausie.ClausIE;
import bobClausIE.bobClausie.Clause;
import bobClausIE.bobClausie.Proposition;
...
//        String sentence = "Albert Einstein is smart.";
        ...
        System.out.println(clausIE.getSemanticGraph().toFormattedString()
                .replaceAll("\n", "\n                   ").trim());
        System.out.println(clausIE.getSemanticGraph().toList());
