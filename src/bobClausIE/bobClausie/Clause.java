...
public class Clause {
	...
	void detectType(Options options) {
		System.out.println(" detectType type="+type);
		...
		System.out.println(" root="+root
				+" dobjects.size()="+dobjects.size()
				+" hasDirectObject="+hasDirectObject
				+" hasIndirectObject="+hasIndirectObject
	 ...
	 */
	int noComplements() {
		System.out.println("dobjects.size()="+dobjects.size()+" complement="+complement
				+" xcomps.size()="+xcomps.size()+"  ccomps.size()="+ccomps.size() );
